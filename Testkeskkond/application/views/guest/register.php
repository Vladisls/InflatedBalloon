    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
			...
			<?php echo form_open("user/registration"); ?>
				...
				<input class="textinmod" type="text" id="email_r" name="email_r" 
                       value="<?php echo set_value('email_r'); ?>" />
				</p>
					<p>
				<label class="textinmod" for="password_r">Password:</label>
				<input class="textinmod" type="password" id="password_r" name="password_r" 
                       value="<?php echo set_value('password_r'); ?>" />
				</p>
				<p>
				<label class="textinmod" for="con_password_r">Confirm Password:</label>
				<input class="textinmod" type="password" id="con_password_r" name="con_password_r" 
                       value="<?php echo set_value('con_password_r'); ?>" />
				</p>
				<p>
